...
def find_and_delete_duplicates(file_path, phone_column_name, mobile_column_name):
    ...
    for row in ws.iter_rows(min_row=2, max_row=ws.max_row):
        ...
        if phone_value_int is not None and phone_value_int in seen:
            combined_key = phone_value_int
        elif mobile_value_int is not None and mobile_value_int in seen:
        ...
        if combined_key is not None:
            ...
            seen[phone_value_int] = row[0].row
            seen[mobile_value_int] = row[0].row
